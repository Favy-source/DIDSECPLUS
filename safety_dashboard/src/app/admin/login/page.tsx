...
export default function AdminLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // After login, check if user is admin or super_admin
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-indigo-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">Security Administration System</p>
        </div>
        <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">
          Administrator Login
        </h2>
        <p className="mt-2 text-center text-sm text-gray-600">
          Access station management and oversight tools
        </p>
      </div>
            ...
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  placeholder="admin@didsecplus.com"
                />
              </div>
            </div>
